import { UI_DATA_TABLE_VIRTUALIZED_CLASS } from '@fubaritico-ds/variants'
...
/**
 * Bare `<table>` primitive for the virtualized DataTable (`.ui-data-table` + `--virtualized`): no scroll
...
export function TableVirtualized({
  ...
  return (
    <table className={cn(UI_DATA_TABLE_VIRTUALIZED_CLASS, className)} {...props} />
  )
}
