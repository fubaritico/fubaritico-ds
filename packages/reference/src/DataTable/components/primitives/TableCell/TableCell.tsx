import { UI_DATA_TABLE_CELL_CLASS } from '@fubaritico-ds/variants'
...
/**
 * `<td>` table-cell primitive (`.ui-data-table__cell`) with the DataTable's default cell padding and row
...
export function TableCell({ className, ...props }: Readonly<ComponentProps<'td'>>) {
  return <td className={cn(UI_DATA_TABLE_CELL_CLASS, className)} {...props} />
}
